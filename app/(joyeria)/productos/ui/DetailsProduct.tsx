...
import { ShoppingCart, Tag, Zap, Minus, Plus } from "lucide-react";
  ...
  const handleAddToCart = () => {
    ...
    if (quantity > product.stock) {
      toast.error("Cantidad no disponible", {
        description: `Solo tenemos ${product.stock} unidades disponibles`,
      });
      return;
    }
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4">
          <Button
            ...
            className="bg-[#A0714C] hover:bg-[#B17953] text-white px-8 py-6 text-lg gap-2 flex-1"
          >
